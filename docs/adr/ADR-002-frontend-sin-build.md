...
## Contexto
La demo debe funcionar offline en el portátil de Oscar, arrancar con un comando y no romperse jamás en vivo. El espectador (Cámara) compara mentalmente con Power BI.
...
## Consecuencias
Cero dependencias de frontend en runtime; el coste es escribir DOM a mano, asumible para una pantalla. ECharts da el nivel visual "Power BI" que pide la narrativa.
